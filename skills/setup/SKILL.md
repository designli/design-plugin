---
name: setup
description: Connect this repository to the Designli portal: portal URL, a scoped personal access token (typed in a terminal, never in chat), the portal project, the MCP configuration, and the commands to run next. Refuses a repository without a git remote unless the designer accepts the risk.
