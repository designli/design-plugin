...
description: Authors one or more artboards (.dc.html) for a single flow step, following the designli-design house rules and the product's DESIGN.md. Optional parallel worker for the flow guide in Claude Code.
