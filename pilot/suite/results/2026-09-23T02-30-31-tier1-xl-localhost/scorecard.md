# Scorecard 2026-09-23T02-30-31-tier1-xl-localhost

tier1 · portal http://localhost:8787 (0.1.0) · plugin 0.2.4 · 73/76 pass · vs 2026-09-23T01-05-03-tier1-xl-localhost
...
| adopt | questionsPerFlow | 1.048q | <= 6q | pass | -5.095 |
| adopt | avoidableQuestions | 0q | <= 0q | pass | -106 |
| adopt | sureAsked | 0q | <= 0q | pass |  |
...
| publish | secondsPerFlow | 0s | <= 10s | pass | -0.1 |
| publish | http429 | 0 | <= 0 | pass | 0 |
| publish | httpCallsPerFlow | 5.619 | recorded |  |  |
...
| xl | publishSecondsPerFlow | 0s | <= 12s | pass | -0.1 |
...
| rounds | A.tooLargeUnavailable | 1 | == 1 | pass |  |
| release2 | editsLanded | 1 | == 1 | pass | 0 |
| release2 | diffShape | 1 | == 1 | pass | 0 |
| release2 | orphanCommentsReadable | 1 | == 1 | pass | 0 |
| release2 | portalOnlyReported | 1 | == 1 | pass |  |
| release2 | orphaningReported | 1 | == 1 | pass |  |
| release2 | deletedFlowStillOnPortal | 0 | <= 0 | pass |  |
| release2 | renamedFlowLeavesOld | 0 | <= 0 | pass |  |
| release2 | waiversSurvive | 1 | == 1 | pass | 0 |
| release2 | stepTitleKept | portal | recorded |  |  |
| roundB | staleEditNeedsManual | 1 | == 1 | pass | 0 |
| roundB | outdatedEdit | 1 | == 1 | pass |  |
...
| release4 | noopHandled | 1 | == 1 | pass |  |
| release4 | noopCalls | 23 | recorded |  |  |
| mcp | devAgent | 4 | == 4 | pass | 0 |
| mcp | clientRefused | 2 | == 2 | pass | 0 |
| mcp | tokenLeaked | 0 | <= 0 | pass | 0 |
| concurrency | threeFlowsClean | 0 | == 1 | FAIL | 0 |
| handoff | created | 1 | >= 1 | pass | 0 |
| handoff | tooLargeRefused | VALIDATION | recorded |  |  |
| roundTrip | unchangedAfterRebuild | 0 | >= 1 | FAIL | -1 |
| roundTrip | filesIdentical | 3 | <= 0 | FAIL | +3 |
...
| reliability | apiCalls | 173 | recorded |  | +5 |
...
| ui | journeyConnectors | 28 | == 28 | pass | -3 |
...
- **roundTrip.unchangedAfterRebuild**: 0: metadata; 1: metadata; 2: metadata; 3: metadata; 4: metadata; 5: metadata; 6: metadata; 7: metadata; 8: metadata; 9: metadata; 10: metadata; 11: metadata
- **roundTrip.filesIdentical**: reports.steps;   before [{"n":"01","id":"Sales","kind":"data","purpose":"Sales · Default","states":{"Default":"01-sales-default.html","Empty":"01-sales-empty.html","Error":"01-sales-error.html","Loading":"01-sales-loading.html"}},{"n":"02","id";   after  [{"n":"01","id":"Sales","kind":"data","purpose":"Sales · Default","states":{"Default":"01-sales-default.html","Loading":"01-sales-loading.html","Empty":"01-sales-empty.html","Error":"01-sales-error.html"}},{"n":"02","id"

## Timings (s)

signin 0.1 · project 0.2 · setup 0.4 · adopt 1 · publish1 2.2 · portal1 0.2 · lostRepo 1.8 · stress 1 · handoffV1 0.3 · journey 0 · roundA 0.5 · release2 3.5 · roundB 0.5 · release3 1.9 · release4 2 · mcp 0 · concurrency3 0.9 · reliability 0.4 · ui 61.4
